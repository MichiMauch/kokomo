---
title: 'Weniger ist machbar: Unser Stromverbrauch im Tiny House'
date: '2025-04-04'
tags: ['tiny house', 'nachhaltiges wohnen', 'strom', 'stromautark', 'solar']
authors: ['default']
summary: 'In 2.5 Jahren nur 200 kWh vom Netz bezogen – dank Tiny House, Solarstrom und bewusstem Leben.'
draft: false
images: 'https://pub-29ede69a4da644b9b81fa3dd5f8e9d6a.r2.dev/solarpanels-dach-optimiert.webp'
type: 'Blog'
---

### 2.5 Jahre, 200 kWh – und was das über unser Leben erzählt
...
Kein Zahlendreher. Das sind **80 kWh pro Jahr**, umgerechnet gerade einmal **6.6 kWh pro Monat**. Zum Vergleich: Ein typischer Zwei-Personen-Haushalt in einer Wohnung verbraucht laut [EKZ](https://www.ekz.ch/de/privatkunden/strom/stromverbrauch/stromverbrauch-vergleichen.html) jährlich zwischen **1'100 und 3'300 kWh**, in einem Einfamilienhaus sogar **2'000 bis 5'000 kWh**. Unser Strombedarf liegt also bei unter **10 %** eines durchschnittlichen Haushalts.
...
![]({IMAGE_PATH}/stromvergleich-80kwh.webp)
